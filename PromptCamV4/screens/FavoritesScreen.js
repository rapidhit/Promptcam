...
const styles = StyleSheet.create({
  ...
  avatarWrap: { width: 52, height: 52, borderRadius: 18, backgroundColor: '#ff4060', alignItems: 'center', justifyContent: 'center', shadowColor: '#ff4060', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 10, elevation: 5 },
  ...
  statsRow: { flexDirection: 'row', paddingVertical: 16, paddingHorizontal: 20, marginBottom: 16 },
