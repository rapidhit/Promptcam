...
export default function SeeAllScreen({ route, navigation }) {
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: bg }]}>
      ...
      <View style={[styles.topBar, { backgroundColor: isDark ? '#1a1a2e' : '#fff', borderBottomColor: isDark ? '#2a2a4e' : '#f0f0f0' }]}>
...
const styles = StyleSheet.create({
  ...
  tag: { backgroundColor: '#fff8ec', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1, borderColor: '#fde8b8', marginRight: 6 },
