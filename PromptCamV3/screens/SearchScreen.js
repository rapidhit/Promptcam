    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.searchWrap}>
        <View style={styles.searchBar}>
          ...
          <TextInput style={styles.searchInput} placeholder="Golden hour, cinematic, moody..." placeholderTextColor="#c0c0c0" value={query} onChangeText={setQuery} />
          {query.length > 0 && (
      ...
      {query.length > 0 && (
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              <TouchableOpacity style={styles.resultCard} onPress={() => navigation.navigate('TemplateDetail', { item })} activeOpacity={0.85}>
                ...
                <View style={styles.resultBody}>
                  ...
                  <View style={styles.tapRow}>
                    <Text style={styles.tapText}>Tap to view full prompt →</Text>
                  </View>
                </View>
              </TouchableOpacity>
            );
...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 16, paddingHorizontal: 16, height: 52, borderWidth: 1.5, borderColor: '#ebebeb', shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.07, shadowRadius: 10, elevation: 3 },
  ...
  suggestPill: { backgroundColor: '#fff', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 8, borderWidth: 1.5, borderColor: '#ebebeb', marginBottom: 8, marginRight: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  ...
  resultCard: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 18, overflow: 'hidden', marginBottom: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 4 },
